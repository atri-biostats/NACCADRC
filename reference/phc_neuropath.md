...
NACCADRC ADSP PHC Neuropath dataset. Neuropath Harmonization Data File.
The data is sourced from the file NACC_ADSP_PHC_Neuropath_2024.csv.
...
A data frame with 19808 rows and 34 variables:
...
- PHC_LEWY_full:
  ...
  PD Braak Staging (0 = None 1 = Brainstem predom. 2 = Limbic/amygdala
  (transitional) 3 = Neocortical (diffuse) 4 = Olfactory bulb or Region
  unspecified NA = Not available)

- PHC_LEWY_grp:

  PD Braak (grouped) (0 = None 1 = Brainstem predom. 2 = Transitional,
  diffuse, olfactory bulb, or region unspecified NA = Not available)

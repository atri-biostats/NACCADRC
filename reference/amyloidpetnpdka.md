...
NACCADRC SCAN/CLARiTI, SCAN Imaging PET dataset. NASCAN Amyloid PET data
...
A data frame with 6168 rows and 345 variables:
...
- NPDKAWHOLECEREBELLUMSUVR:

- NPDKACOMPOSITEREFSUVR:

- NPDKACEREBELLUMCORTEXSUVR:

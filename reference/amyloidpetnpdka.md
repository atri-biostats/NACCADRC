...
investigator_clariti_amyloidpetnpdka_naccFREEZE.csv,
investigator_scan_amyloidpetnpdka_nacc72.csv,
investigator_scan_mp_amyloidpetnpdka_nacc72.csv.

NACCADRC UDS, SCAN Imaging Amyloid PET dataset. The data is sourced from
the file(s) investigator_clariti_amyloidpetnpdka_naccFREEZE.csv,
investigator_scan_amyloidpetnpdka_nacc72.csv,
investigator_scan_mp_amyloidpetnpdka_nacc72.csv.
...
A data frame with 5481 rows and 180 variables:

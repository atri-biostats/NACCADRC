...
NACCADRC SCAN/CLARiTI, SCAN Imaging PET dataset. SCAN Tau PET data
...
A data frame with 3324 rows and 350 variables:
...
- INFERIORCEREBELLUMSUVR:

- ERODEDSUBCORTICALWMSUVR:

...
NACCADRC ADSP PHC Imaging T1 dataset. T1 Freesurfer Harmonization Data
File. The data is sourced from the file
NACC_ADSP_PHC_T1_Freesurfer_2024.csv.

## Usage

``` r
data(phc_t1_freesurfer)
```

## Format

A data frame with 7740 rows and 194 variables:
...
- Left.Accumbens.area_combat:

  Left accumbens volume harmonized with combat

- Left.Amygdala_combat:
...
- Left.Thalamus.Proper_combat:

  Left thalamus volume harmonized with combat

- Left.VentralDC_combat:
